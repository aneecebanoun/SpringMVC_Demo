...
public class DataLoadingUtility {
	...
	static {
		...
		tradeEntries.add(seller1);
		tradeEntries.add(seller2);
		tradeEntries.add(seller3);
		tradeEntries.add(buyer1);
		tradeEntries.add(buyer2);
		tradeEntries.add(buyer3);
	...
	public static double getRandomFromRange(double min, double max){
